...
function ctc_gmaps_types() {
	...
	$types = array(
		'ROADMAP'	=> _x( 'Road', 'map', 'churchthemes-framework' ),
		'SATELLITE'	=> _x( 'Satellite', 'map', 'churchthemes-framework' ),
		'HYBRID'	=> _x( 'Hybrid', 'map', 'churchthemes-framework' ),
		'TERRAIN'	=> _x( 'Terrain', 'map', 'churchthemes-framework' )
	);
