...
function ctc_add_meta_box_location() {
	...
	$meta_box = array(
		...
		'title' 	=> _x( 'Location Details', 'location meta box', 'churchthemes-framework' ),
		...
		'fields' => array(
			...
			*/
			...
			'_ctc_location_address' => array(
				'name'				=> _x( 'Address', 'location meta box', 'churchthemes-framework' ),
				'after_name'		=> '', // (Optional), (Required), etc.
				'after_input'		=> '', // text to show to right of input (fields: text, select, number, upload, url, date, time)
				'desc'				=> '',
			...
			'_ctc_location_phone' => array(
				'name'				=> _x( 'Phone', 'location meta box', 'churchthemes-framework' ),
				'after_name'		=> '', // (Optional), (Required), etc.
				'after_input'		=> '', // text to show to right of input (fields: text, select, number, upload, url, date, time)
				'desc'				=> '',
				'type'				=> 'text', // text, textarea, checkbox, radio, select, number, upload, upload_textarea, url, date, time
			...
			'_ctc_location_map_type' => array(
				'name'				=> _x( 'Map Type', 'location meta box', 'churchthemes-framework' ),
				'after_name'		=> '', // (Optional), (Required), etc.
				'after_input'		=> '', // text to show to right of input (fields: text, select, number, upload, url, date, time)
				'desc'				=> _x( 'You can show a road map, satellite imagery, a combination of both (hybrid) or terrain.', 'location meta box', 'churchthemes-framework' ),
			...
			'_ctc_location_map_zoom' => array(
				'name'				=> _x( 'Map Zoom', 'location meta box', 'churchthemes-framework' ),
				'after_name'		=> '', // (Optional), (Required), etc.
				'after_input'		=> '', // text to show to right of input (fields: text, select, number, upload, url, date, time)
				'desc'				=> _x( 'A lower number is more zoomed out while a higher number is more zoomed in.', 'location meta box', 'churchthemes-framework' ),
				'type'				=> 'select', // text, textarea, checkbox, radio, select, number, upload, upload_textarea, url, date, time
				'checkbox_label'	=> '', //show text after checkbox
...
function ctc_location_columns( $columns ) {
	...
	$insert_array = array();
	$insert_array['ctc_location_thumbnail'] = __( 'Thumbnail', 'churchthemes-framework' );
	$columns = ctc_array_merge_after_key( $columns, $insert_array, 'cb' );

	// insert address and order after location (title)
	$insert_array = array();
	if ( ctc_field_supported( 'locations', '_ctc_location_address' ) ) $insert_array['ctc_location_address'] = _x( 'Address', 'location admin column', 'churchthemes-framework' );
	if ( ctc_field_supported( 'locations', '_ctc_location_times' ) ) $insert_array['ctc_location_times'] = _x( 'Times', 'location admin column', 'churchthemes-framework' );
	$insert_array['ctc_location_order'] = _x( 'Order', 'sorting', 'churchthemes-framework' );
	$columns = ctc_array_merge_after_key( $columns, $insert_array, 'title' );

	//change "Location" to "Location"
	$columns['title'] = _x( 'Location', 'location admin column', 'churchthemes-framework' );
