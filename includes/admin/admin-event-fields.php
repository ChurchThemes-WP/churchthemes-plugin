...
function ctc_add_meta_box_event_date() {
	...
	$meta_box = array(
		...
		'title' 	=> _x( 'Date & Time', 'event meta box', 'churchthemes-framework' ),
		'post_type'	=> 'ctc_event',
		...
		'fields' => array(
			...
			'option_key' => array(
				...
				'desc'				=> __( 'This is the description below the field.', 'churchthemes-framework' ), // description below input
			...
			*/
			...
			'_ctc_event_start_date' => array(
				'name'				=> __( 'Start Date', 'churchthemes-framework' ),
				'after_name'		=> __( '(Required)', 'churchthemes-framework' ), // (Optional), (Required), etc.
				...
				'upload_title'		=> '', // title appearing at top of media frame
				'upload_type'		=> '', // optional type of media to filter by (image, audio, video, application/pdf)
				'default'			=> date('Y'), // value to pre-populate option with (before first save or on reset)
				'no_empty'			=> false, // if user empties value, force default to be saved instead
				'allow_html'		=> false, // allow HTML to be used in the value (text, textarea)
				'attributes'		=> array(), // attr => value array (e.g. set min/max for number type)
				'class'				=> '', // class(es) to add to input (try ctmb-medium, ctmb-small, ctmb-tiny)
			...
			'_ctc_event_end_date' => array(
				'name'				=> __( 'End Date', 'churchthemes-framework' ),
				'after_name'		=> '', // (Optional), (Required), etc.
				'after_input'		=> '', // text to show to right of input (fields: text, select, number, upload, url, date, time)
				'desc'				=> '',
				'type'				=> 'date', // text, textarea, checkbox, radio, select, number, upload, upload_textarea, url, date, time
			...
			'_ctc_event_start_time' => array(
				'name'				=> __( 'Start Time', 'churchthemes-framework' ),
				'after_name'		=> '', // (Optional), (Required), etc.
				'after_input'		=> '', // text to show to right of input (fields: text, select, number, upload, url, date, time)
				'desc'				=> '',
			...
			'_ctc_event_end_time' => array(
				'name'				=> __( 'End Time', 'churchthemes-framework' ),
				'after_name'		=> '', // (Optional), (Required), etc.
				'after_input'		=> '', // text to show to right of input (fields: text, select, number, upload, url, date, time)
				'desc'				=> '',
				'type'				=> 'time', // text, textarea, checkbox, radio, select, number, upload, upload_textarea, url, date, time
			...
			'_ctc_event_hide_time_range' => array(
				...
				'checkbox_label'	=> __( 'Do not show times entered above (use only for ordering events)', 'churchthemes-framework' ), //show text after checkbox
				'options'			=> array(), // array of keys/values for radio or select
				'upload_button'		=> '', // text for button that opens media frame
				'upload_title'		=> '', // title appearing at top of media frame
				'upload_type'		=> '', // optional type of media to filter by (image, audio, video, application/pdf)
			...
			'_ctc_event_time' => array(
				'name'				=> __( 'Time Description', 'churchthemes-framework' ),
				'after_name'		=> '', // (Optional), (Required), etc.
				'after_input'		=> '', // text to show to right of input (fields: text, select, number, upload, url, date, time)
				'desc'				=> __( 'Optionally describe the time (e.g. "9:30 am and 11:00 am" or "After Second Service")', 'churchthemes-framework' ),
				'type'				=> 'text', // text, textarea, checkbox, radio, select, number, upload, upload_textarea, url, date, time
				'checkbox_label'	=> '', //show text after checkbox
				'options'			=> array(), // array of keys/values for radio or select
				'upload_button'		=> '', // text for button that opens media frame
			...
			'_ctc_event_recurrence' => array(
				'name'				=> __( 'Recurrence', 'churchthemes-framework' ),
				'after_name'		=> '', // (Optional), (Required), etc.
				'after_input'		=> '', // text to show to right of input (fields: text, select, number, upload, url, date, time)
				'desc'				=> _x( "Dates automatically move forward after event ends.", 'event meta box', 'churchthemes-framework' ),
				'type'				=> 'select', // text, textarea, checkbox, radio, select, number, upload, upload_textarea, url, date, time
				'checkbox_label'	=> '', //show text after checkbox
				'options'			=> array( // array of keys/values for radio or select
					'none'			=> _x( 'None', 'event meta box', 'churchthemes-framework' ),
					'weekly'	=> _x( 'Weekly', 'event meta box', 'churchthemes-framework' ),
					'monthly'	=> _x( 'Monthly', 'event meta box', 'churchthemes-framework' ),
					'yearly'	=> _x( 'Yearly', 'event meta box', 'churchthemes-framework' ),
				),
				'upload_button'		=> '', // text for button that opens media frame
				'upload_title'		=> '', // title appearing at top of media frame
				'upload_type'		=> '', // optional type of media to filter by (image, audio, video, application/pdf)
			...
			'_ctc_event_recurrence_end_date' => array(
				'name'				=> __( 'Recur Until', 'churchthemes-framework' ),
				'after_name'		=> '',
				'after_input'		=> '', // text to show to right of input (fields: text, select, number, upload, url, date, time)
				'desc'				=> '',
				'type'				=> 'date', // text, textarea, checkbox, radio, select, number, upload, upload_textarea, url, date, time
...
function ctc_add_meta_box_event_location() {
	...
	$meta_box = array(
		...
		'title' 	=> _x( 'Location', 'event meta box', 'churchthemes-framework' ),
		'post_type'	=> 'ctc_event',
		'context'	=> 'normal', // where the meta box appear: normal (left above standard meta boxes), advanced (left below standard boxes), side
		'priority'	=> 'high', // high, core, default or low (see this: http://www.wproots.com/ultimate-guide-to-meta-boxes-in-wordpress/)
		...
		'fields' => array(
			...
			*/
			...
			'_ctc_event_venue' => array(
				'name'				=> __( 'Venue', 'churchthemes-framework' ),
				'after_name'		=> '', // (Optional), (Required), etc.
				'after_input'		=> '', // text to show to right of input (fields: text, select, number, upload, url, date, time)
				'desc'				=> __( 'You can provide a building name, room number or other location name to help people find the event.', 'churchthemes-framework' ),
				'type'				=> 'text', // text, textarea, checkbox, radio, select, number, upload, upload_textarea, url, date, time
				'checkbox_label'	=> '', //show text after checkbox
				'options'			=> array(), // array of keys/values for radio or select
				'upload_button'		=> '', // text for button that opens media frame
			...
			'_ctc_event_address' => array(
				'name'				=> _x( 'Address', 'event meta box', 'churchthemes-framework' ),
				'after_name'		=> '', // (Optional), (Required), etc.
				'after_input'		=> '', // text to show to right of input (fields: text, select, number, upload, url, date, time)
				'desc'				=> __( 'You can enter an address if it is necessary for people to find this event.', 'churchthemes-framework' ),
			...
			'_ctc_event_show_directions_link' => array(
				...
				'desc'				=> '',
				'type'				=> 'checkbox', // text, textarea, checkbox, radio, select, number, upload, upload_textarea, url, date, time
				'checkbox_label'	=> __( 'Show directions link', 'churchthemes-framework' ), //show text after checkbox
				'options'			=> array(), // array of keys/values for radio or select
				'upload_button'		=> '', // text for button that opens media frame
				'upload_title'		=> '', // title appearing at top of media frame
				'upload_type'		=> '', // optional type of media to filter by (image, audio, video, application/pdf)
			...
			'_ctc_event_map_type' => array(
				'name'				=> _x( 'Map Type', 'event meta box', 'churchthemes-framework' ),
				'after_name'		=> '', // (Optional), (Required), etc.
				'after_input'		=> '', // text to show to right of input (fields: text, select, number, upload, url, date, time)
				'desc'				=> _x( 'You can show a road map, satellite imagery, a combination of both (hybrid) or terrain.', 'event meta box', 'churchthemes-framework' ),
				'type'				=> 'select', // text, textarea, checkbox, radio, select, number, upload, upload_textarea, url, date, time
				'checkbox_label'	=> '', //show text after checkbox
			...
			'_ctc_event_map_zoom' => array(
				'name'				=> _x( 'Map Zoom', 'event meta box', 'churchthemes-framework' ),
				'after_name'		=> '', // (Optional), (Required), etc.
				'after_input'		=> '', // text to show to right of input (fields: text, select, number, upload, url, date, time)
				'desc'				=> _x( 'A lower number is more zoomed out while a higher number is more zoomed in.', 'event meta box', 'churchthemes-framework' ),
				'type'				=> 'select', // text, textarea, checkbox, radio, select, number, upload, upload_textarea, url, date, time
				'checkbox_label'	=> '', //show text after checkbox
...
function ctc_event_columns( $columns ) {
	...
	$insert_array = array();
	$insert_array['ctc_event_thumbnail'] = __( 'Thumbnail', 'churchthemes-framework' );
	$columns = ctc_array_merge_after_key( $columns, $insert_array, 'cb' );

	// insert start date, venue after title
	$insert_array = array();
	if ( ctc_field_supported( 'events', '_ctc_event_start_date' ) ) $insert_array['ctc_event_dates'] = _x( 'When', 'events admin column', 'churchthemes-framework' );
	if ( ctc_field_supported( 'events', '_ctc_event_venue' ) ) $insert_array['ctc_event_venue'] = _x( 'Where', 'events admin column', 'churchthemes-framework' );
...
function ctc_event_columns_content( $column ) {
	...
	switch ( $column ) {
		...
		case 'ctc_event_dates' :
			...
			echo '<b>';
			echo esc_html( implode( _x( ' &ndash; ', 'date range separator', 'churchthemes-framework' ), $dates ) );
			echo '</b>';
			...
			if ( $start_time && ! $hide_time_range ) {
				...
				if ( ! $end_time ) { // just start time
					...
					echo esc_html( implode( _x( ' &ndash; ', 'time range separator', 'churchthemes-framework' ), array(
				...
				switch ( $recurrence ) {
					...
					case 'weekly' :
						...
						if ( $recurrence_end_date ) {
							...
							$recurrence_note = sprintf(
								__( 'Every week until %1$s', 'churchthemes-framework' ),
								$recurrence_end_date_localized
							);

						} else {
							$recurrence_note = __( 'Every week', 'churchthemes-framework' );
						}
					...
					case 'monthly' :
						...
						if ( $recurrence_end_date ) {
							...
							/* translators: %1$s is recurrence end date */
							$recurrence_note = sprintf(
								__( 'Every month until %1$s', 'churchthemes-framework' ),
								$recurrence_end_date_localized
							);

						} else {
							$recurrence_note = __( 'Every month', 'churchthemes-framework' );
						}
					...
					case 'yearly' :
						...
						if ( $recurrence_end_date ) {
							...
							/* translators: %1$s is recurrence end date */
							$recurrence_note = sprintf(
								__( 'Every year until %1$s', 'churchthemes-framework' ),
								$recurrence_end_date_localized
							);

						} else {
							$recurrence_note = __( 'Every year', 'churchthemes-framework' );
						}
