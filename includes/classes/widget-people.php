...
class CTFW_Widget_People extends CTFW_Widget {
		...
		$fields = array(
			...
			*/
			...
			'group' => array(
				...
				'number_min'		=> '', // lowest possible value for number type
				'number_max'		=> '', // highest possible value for number type
				'options'			=> ctc_term_options( 'ctc_person_group', array( // array of keys/values for radio or select
	...
	function ctc_get_posts() {
		...
		// Group argument
		if ( 'all' != $this->ctc_instance['group'] && $group_term = get_term( $this->ctc_instance['group'], 'ctc_person_group' ) ) {
