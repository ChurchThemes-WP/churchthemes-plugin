 ...
 */
function ctc_previous_next_post_where( $direction ) {
 ...
 */
function ctc_previous_post_where( $where ) {
	return ctc_previous_next_post_where( 'previous' );
}
 ...
 * @return string Custom WHERE clause
 */
function ctc_next_post_where( $where ) {
	return ctc_previous_next_post_where( 'next' );
}
 ...
 */
function ctc_previous_post_sort( $sort ) {
 ...
 * @return string Custom ORDER BY clause
 */
function ctc_next_post_sort( $sort ) {
