...
function ctc_add_post_mime_types( $post_mime_types ) {
	...
	$post_mime_types['application/pdf'] = array(
		__( 'PDF', 'churchthemes-framework' ),
		__( 'Manage PDFs', 'churchthemes-framework' ),
		_n_noop( 'PDF <span class="count">(%s)</span>', 'PDFs <span class="count">(%s)</span>', 'churchthemes-framework' )
	);
