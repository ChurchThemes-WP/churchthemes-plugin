...
function ctc_settings_setup() {
	...
	$config = array(
		...
		// Titles
		'page_title' 	=> sprintf( __( '%1$s Settings', 'churchthemes-framework' ), CTC_NAME ),
		'menu_title'	=> CTC_NAME,
		...
		'sections' => array(
			...
			'licenses' => array(
				...
				// Title
				'title'	=> _x( 'Add-on Licenses', 'settings', 'churchthemes-framework' ),
			...
			'second_section' => array(
				...
				// Title
				'title'	=> __( 'Second Section', 'churchthemes-framework' ),

				// Description
				'desc'	=> __( 'Second section description.', 'churchthemes-framework' ),
